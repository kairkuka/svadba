  ...
  v1: [
    {
      ...
      rating: 5,
      date: '12 июня',
      text: 'Команда быстро поняла стиль свадьбы и собрала зал ровно как на референсах.',
    },
    {
      id: 'rv1-2',
      author: 'Мадина',
...
const vendorBase: Array<Omit<Vendor, 'contactPhone' | 'reviewCount' | 'reviews'>> = [
  {
    ...
    description:
      'Оформление камерных и больших свадеб: президиум, фотозона, флористика, световые акценты и монтаж под ключ.',
    packages: [
      {
        name: 'Камерный декор',
        price: 280000,
  ...
  },
  {
    ...
    description:
      'Свадебная фотосъемка полного дня, love story, семейные портреты и быстрая серия фото в течение 72 часов.',
    packages: [
      {
        name: 'До банкета',
        price: 180000,
  ...
  },
  {
    ...
    description:
      'Свадебные фильмы и динамичные highlights с двумя операторами, аэросъемкой и цветокоррекцией.',
    packages: [
      {
        name: 'Highlights',
        price: 260000,
  ...
  },
  {
    ...
    description:
      'Многоярусные свадебные торты, дегустационные наборы и индивидуальный декор под стилистику свадьбы.',
    packages: [
      {
        name: 'Камерный торт',
        price: 85000,
